...
import org.example.order_domain.order_application_service.ports.OrderCreatedUseCase;
...
@Service
public class CreatedOrderUseCase implements OrderCreatedUseCase {
